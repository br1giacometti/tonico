...
const extractABTestingStyles = body => {
  ...
  if (body.includes('<template')) {
    const $ = cheerio__WEBPACK_IMPORTED_MODULE_2___default.a.load(body);
    const templates = $('template');
    templates.toArray().forEach(element => {
      const str = $(element).html();
      const styles = cheerio__WEBPACK_IMPORTED_MODULE_2___default.a.load(String(str))('style');
