...
var CarouselComponent = /** @class */ (function (_super) {
    ...
    CarouselComponent.prototype.render = function () {
        ...
        return (React.createElement(react.BuilderAsyncRequestsContext.Consumer, null, function (value) {
            ...
            return (React.createElement(react.BuilderStoreContext.Consumer, null, function (state) { return (React.createElement("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-carousel" },
                ...
                React.createElement(Slider__default['default'], tslib.__assign({ responsive: _this.props.responsive, ref: function (ref) { return (_this.sliderRef = ref); }, afterChange: function (slide) {
                        // TODO; callbacks
                        if (_this.divRef) {
                    ...
                    ? _this.props.builderBlock &&
                        ...
                        _this.props.builderBlock.children.map(function (block, index) {
                            ...
                            return (React.createElement(react.BuilderBlockComponent, { key: block.id, block: block, index: index, child: true }));
                        })
                    : _this.props.slides &&
...
var AccordionComponent = /** @class */ (function (_super) {
    ...
    AccordionComponent.prototype.getAccordionItem = function (titleBlocks, detailBlocks, index, openGridItemOrder, onlyOneAtATime, fromChildren) {
        ...
        React.createElement("span", { key: index },
            ...
            open && (React.createElement("div", { className: "builder-accordion-detail builder-accordion-detail-" + (open ? 'open' : 'closed'), style: tslib.__assign({ order: typeof openGridItemOrder === 'number' ? openGridItemOrder : undefined, maxHeight: this.props.animate ? (open ? '100vh' : 0) : undefined, transition: this.props.animate ? 'max-height 0.5s' : undefined }, (grid && {
                    width: '100%',
                })) }, open &&
