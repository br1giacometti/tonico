    ...
    var Builder = /** @class */ (function () {
        ...
        Builder.prototype.requestUrl = function (url) {
            if (Builder.isBrowser) {
                ...
                return fetch$1(url, this.authToken
                    ? {
                        headers: {
    ...
    */
    ...
    var withEmotionCache = function withEmotionCache(func) {
      var render = function render(props, ref) {
        return react_4(EmotionCacheContext.Consumer, null, function (cache) {
          return func(props, cache, ref);
        });
      }; // $FlowFixMe


      return react_5(render);
    };
    ...
    if (!isBrowser$3) {
      ...
      function (_React$Component) {
        ...
        _proto.render = function render() {
          return react_4(EmotionCacheContext.Provider, this.state, this.props.children(this.state.value));
        };
      ...
      withEmotionCache = function withEmotionCache(func) {
        return function (props) {
          return react_4(EmotionCacheContext.Consumer, null, function (context) {
            if (context === null) {
              return react_4(BasicProvider, null, function (newContext) {
    ...
    var render = function render(cache, props, theme, ref) {
      ...
      if (!isBrowser$3 && rules !== undefined) {
        ...
        return react_4(react_6, null, react_4("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
    ...
    withEmotionCache(function (props, cache, ref) {
      ...
      if (typeof props.css === 'function') {
        return react_4(ThemeContext.Consumer, null, function (theme) {
    ...
    var jsx = function jsx(type, props) {
      ...
      if (props == null || !hasOwnProperty$1.call(props, 'css')) {
        // $FlowFixMe
        return react_4.apply(undefined, args);
      }
      ...
      return react_4.apply(null, createElementArgArray);
    };
    ...
    var ClassNames = withEmotionCache(function (props, context) {
      return react_4(ThemeContext.Consumer, null, function (theme) {
        ...
        if (!isBrowser$3 && rules.length !== 0) {
          ...
          return react_4(react_6, null, react_4("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
            __html: rules
    ...
    var version$1="1.1.32",_a;"undefined"!=typeof window&&(null===(_a=window.parent)||void 0===_a||_a.postMessage({type:"builder.isReactSdk",data:{value:!0,supportsPatchUpdates:"v3",priorVersion:version$1}},"*"))
    /*! *****************************************************************************
    ...
    */
      ...
      function InnerSlider(props) {
        ...
        _this.componentWillMount = function () {
          ...
          if (_this.props.lazyLoad) {
            var slidesToLoad = (0, innerSliderUtils.getOnDemandLazySlides)(_extends({}, _this.props, _this.state));
        ...
        _this.ssrInit = function () {
          if (_this.props.variableWidth) {
            var _trackWidth = 0,
                _trackLeft = 0;
            var childrenWidths = [];
            var preClones = (0, innerSliderUtils.getPreClones)(_extends({}, _this.props, _this.state, {
              slideCount: _this.props.children.length
            }));
            var postClones = (0, innerSliderUtils.getPostClones)(_extends({}, _this.props, _this.state, {
              slideCount: _this.props.children.length
            }));
        ...
        _this.slideHandler = function (index) {
          ...
          var _slideHandler = (0, innerSliderUtils.slideHandler)(_extends({
            index: index
          }, _this.props, _this.state, {
            trackRef: _this.track,
        ...
        _this.swipeMove = function (e) {
          var state = (0, innerSliderUtils.swipeMove)(e, _extends({}, _this.props, _this.state, {
            trackRef: _this.track,
            listRef: _this.list,
        ...
        _this.swipeEnd = function (e) {
          var state = (0, innerSliderUtils.swipeEnd)(e, _extends({}, _this.props, _this.state, {
            trackRef: _this.track,
            listRef: _this.list,
            slideIndex: _this.state.currentSlide
          }));
        ...
        _this.play = function () {
          ...
          if (_this.props.rtl) {
            ...
            if ((0, innerSliderUtils.canGoNext)(_extends({}, _this.props, _this.state))) {
              nextIndex = _this.state.currentSlide + _this.props.slidesToScroll;
            } else {
              return false;
            }
    ...
    var CarouselComponent = /** @class */ (function (_super) {
        ...
        CarouselComponent.prototype.render = function () {
            ...
            return (react_4(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (react_4(BuilderStoreContext.Consumer, null, function (state) { return (react_4("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-carousel" },
                    Builder.isServer ? (react_4("style", { type: "text/css", dangerouslySetInnerHTML: { __html: slickStyles } })) : (react_4("style", { type: "text/css" }, slickStyles)),
                    react_4(Slider, __assign({ responsive: _this.props.responsive, ref: function (ref) { return (_this.sliderRef = ref); }, afterChange: function (slide) {
                            // TODO; callbacks
                            if (_this.divRef) {
                        ...
                        // OOF!!
                        nextArrow: react_4("div", null,
                            react_4(BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.prevButton", blocks: _this.props.prevButton })), 
                        // OOF!!
                        prevArrow: react_4("div", null,
                            react_4(BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.nextButton", blocks: _this.props.nextButton })) }, _this.props.slickProps), _this.props.useChildrenForSlides
                                ...
                                if (block.repeat && block.repeat.collection) {
                                    ...
                                    if (Array.isArray(array)) {
                                        ...
                                        return array.map(function (data, index) {
                                            ...
                                            return (react_4(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                                react_4(BuilderBlock, { block: __assign(__assign({}, block), { repeat: null }), index: index, child: true })));
                                        });
                                    }
                                }
                                return (react_4(BuilderBlock, { key: block.id, block: block, index: index, child: true }));
                            })
                        : _this.props.slides &&
                            ...
                            react_4(BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.slides." + index + ".content", child: true, blocks: slide.content || slide })); })))); }));
            }));
        };
        ...
        TabsComponent.prototype.render = function () {
            ...
            return (react_4(react_6, null,
                react_4("span", { style: {
                    ...
                    this.props.tabs.map(function (item, index) { return (react_4("span", { key: index, className: 'builder-tab-wrap ' + (_this.activeTabSpec === item ? 'builder-tab-active' : ''), style: __assign({}, ((_this.activeTabSpec === item && _this.props.activeTabStyle) || undefined)), onClick: function () {
                ...
                this.activeTabSpec && (react_4(BuilderBlocks, { parentElementId: this.props.builderBlock.id, dataPath: "component.options.tabs." + this.state.activeTab + ".content", blocks: this.activeTabSpec.content }))));
        };
    ...
    var AccordionComponent = /** @class */ (function (_super) {
        ...
        AccordionComponent.prototype.getAccordionItem = function (titleBlocks, detailBlocks, index, openGridItemOrder, onlyOneAtATime, fromChildren) {
            ...
            react_4(react_6, { key: index },
                react_4("div", { className: "builder-accordion-title builder-accordion-title-" + (open ? 'open' : 'closed'), style: __assign({ cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }, (grid && __assign({ width: this.props.gridRowWidth }, (typeof openGridItemOrder === 'number' && {
                    ...
                    } }, fromChildren ? (titleBlocks.map(function (block, index) { return (react_4(BuilderBlock, { key: index, block: __assign(__assign({}, block), { repeat: null }), index: index, child: true })); })) : (react_4(BuilderBlocks, { blocks: titleBlocks, dataPath: "items." + index + ".title" }))),
                open && (react_4("div", { className: "builder-accordion-detail builder-accordion-detail-" + (open ? 'open' : 'closed'), style: __assign({ order: typeof openGridItemOrder === 'number' ? openGridItemOrder : undefined, maxHeight: this.props.animate ? (open ? '100vh' : 0) : undefined, transition: this.props.animate ? 'max-height 0.5s' : undefined }, (grid && {
                        width: '100%',
                    })) }, open &&
                    (fromChildren ? (detailBlocks.map(function (block, index) { return (react_4(BuilderBlock, { key: index, block: __assign(__assign({}, block), { repeat: null }), index: index, child: true })); })) : (react_4(BuilderBlocks, { blocks: detailBlocks, dataPath: "items." + index + ".detail" })))))));
        };
        AccordionComponent.prototype.render = function () {
            ...
            return (react_4(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (react_4(BuilderStoreContext.Consumer, null, function (state) { return (react_4("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-accordion", style: __assign({ display: 'flex', alignItems: 'stretch', flexDirection: 'column' }, (grid && {
                        flexDirection: 'row',
                            ...
                            if (block.repeat && block.repeat.collection) {
                                ...
                                if (Array.isArray(array)) {
                                    return array.map(function (data, index) {
                                        ...
                                        // TODO: Builder state produce the data
                                        var childState = __assign(__assign({}, state.state), (_a = { $index: index, $item: data }, _a[itemName_1] = data, _a));
                                        return (react_4(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) }, _this.getAccordionItem(block.children ? [block.children[0]] : [], block.children ? [block.children[1]] : [], index, openGridItemOrder, onlyOneAtATime, true)));
                                    });
                                }
                            }
    ...
    **/
    ...
    var MasonryComponent$1 = /** @class */ (function (_super) {
        ...
        MasonryComponent.prototype.render = function () {
            ...
            return (react_4("div", { style: {
                    opacity: Builder.isBrowser && this.state.layoutComplete ? 1 : 0,
                    transition: 'opacity 0.2s',
                } },
                react_4(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                    _this._errors = value && value.errors;
                    _this._logs = value && value.logs;
                    return (react_4(BuilderStoreContext.Consumer, null, function (state) { return (react_4("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-masonry" },
                        react_4(lib$1, { onLayoutComplete: function () {
                                    ...
                                    if (block.repeat && block.repeat.collection) {
                                        ...
                                        if (Array.isArray(array)) {
                                            ...
                                            return array.map(function (data, index) {
                                                ...
                                                // TODO: Builder state produce the data
                                                var childState = __assign(__assign({}, state.state), (_a = { $index: index, $item: data }, _a[itemName_1] = data, _a));
                                                return (react_4("div", { className: "masonry-item", style: itemStyle },
                                                    react_4(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                                        react_4(BuilderBlock, { block: __assign(__assign({}, block), { repeat: null }), index: index, child: true }))));
                                            });
                                        }
                                    }
                                    return (react_4("div", { style: itemStyle, className: "masonry-item" },
                                        react_4(BuilderBlock, { key: block.id, block: block, index: index, child: true })));
                                })
                            : _this.props.tiles &&
                                ...
                                react_4("div", { style: itemStyle, className: "masonry-item" },
                                    react_4(BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.tiles." + index + ".content", child: true, blocks: tile.content || tile }))); })))); }));
                })));
        };
