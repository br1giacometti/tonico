...
var SymbolComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SymbolComponent.prototype, "placeholder", {
        get: function () {
            return (core_1.jsx("div", { css: { padding: 10 } }, "Symbols let you reuse dynamic elements across your content. Please choose a model and entry for this symbol."));
        },
        enumerable: true,
        configurable: true
    });
    ...
    SymbolComponent.prototype.render = function () {
        ...
        var _a;
        if (this.useStatic) {
            return core_1.jsx("div", { ref: function (el) { return (_this.staticRef = el); } });
        }
