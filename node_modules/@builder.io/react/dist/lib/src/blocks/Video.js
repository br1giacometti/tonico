...
var VideoComponent = /** @class */ (function (_super) {
    ...
    VideoComponent.prototype.render = function () {
        ...
        return (core_1.jsx("div", { ref: function (ref) { return (_this.containerRef = ref); }, css: { position: 'relative' } },
            ...
            aspectRatio && !(this.props.fitContent && children) ? (core_1.jsx("div", { css: {
                    width: '100%',
                    paddingTop: aspectRatio * 100 + '%',
                    pointerEvents: 'none',
                    fontSize: 0,
                } })) : null,
            children && this.props.fitContent ? (core_1.jsx("div", { css: { display: 'flex', flexDirection: 'column', alignItems: 'stretch' } }, children)) : (core_1.jsx("div", { css: {
                    display: 'flex',
