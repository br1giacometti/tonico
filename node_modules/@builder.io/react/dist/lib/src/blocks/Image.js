        ...
        return (core_1.jsx(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) {
            ...
            return (core_1.jsx(react_1.default.Fragment, null,
                amp ? (imageContents) : (core_1.jsx("picture", { ref: function (ref) { return (_this.pictureRef = ref); } },
                    ...
                    imageContents)),
                aspectRatio && !amp && !(fitContent && children && children.length) ? (core_1.jsx("div", { className: "builder-image-sizer", css: {
                        width: '100%',
                        paddingTop: aspectRatio * 100 + '%',
                        pointerEvents: 'none',
                        fontSize: 0,
                    } }, ' ')) : null,
                children && children.length ? (fitContent ? (children.map(function (block, index) { return (core_1.jsx(builder_block_component_1.BuilderBlock, { key: block.id, block: block })); })) : (
