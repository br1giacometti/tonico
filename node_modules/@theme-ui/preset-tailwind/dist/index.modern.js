...
const colors = _extends({}, baseColors, {
...
const fonts = _extends({}, baseFonts, {
  body: baseFonts.sans,
  heading: 'inherit',
...
const fontWeights = _extends({}, baseFontWeights, {
...
const lineHeights = _extends({}, baseLineHeights, {
...
const sizes = _extends({}, tailwindSpacing, tailwindMaxWidth, tailwindWidth, {
  full: '100%',
  screenHeight: '100vh',
  screenWidth: '100vw'
});
