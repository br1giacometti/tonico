(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@emotion/styled'), require('@theme-ui/css'), require('@styled-system/should-forward-prop'), require('@styled-system/space'), require('@styled-system/color'), require('react'), require('@emotion/react')) :
  typeof define === 'function' && define.amd ? define(['exports', '@emotion/styled', '@theme-ui/css', '@styled-system/should-forward-prop', '@styled-system/space', '@styled-system/color', 'react', '@emotion/react'], factory) :
  (global = global || self, factory(global.components = {}, global.styled, global.css, global.shouldForwardProp$1, global.space, global.color, global.react, global.react));
}(this, (function (exports, styled, css, shouldForwardProp$1, space, color, React, react) {
  ...
  var boxSystemProps = [].concat(space__default['default'].propNames, color__default['default'].propNames);
  /**
   * @internal
  ...
  var shouldForwardProp = shouldForwardProp$1.createShouldForwardProp(boxSystemProps);
  ...
  var Box = styled__default['default']('div', {
    ...
    margin: 0,
    minWidth: 0
  }, base, variant, space__default['default'], color__default['default'], sx, function (props) {
    return props.css;
  });
  Box.displayName = 'Box';
  ...
  var Grid = React__default['default'].forwardRef(function Grid(_ref, ref) {
  ...
  var Button = React__default['default'].forwardRef(function Button(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "button",
      variant: "primary"
  ...
  var Link = React__default['default'].forwardRef(function Link(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "a",
      variant: "styles.a"
  ...
  var Paragraph = React__default['default'].forwardRef(function Paragraph(_ref, ref) {
    var sx = _ref.sx,
  ...
  var Text = React__default['default'].forwardRef(function Text(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      as: "span",
      ref: ref,
      variant: "default"
  ...
  var Heading = React__default['default'].forwardRef(function Heading(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "h2",
      variant: "heading"
  ...
  var Image = React__default['default'].forwardRef(function Image(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "img"
    }, props, {
  ...
  var Card = React__default['default'].forwardRef(function Card(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      variant: "primary"
    }, props, {
  ...
  var Label = React__default['default'].forwardRef(function Label(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "label",
      variant: "label"
  ...
  var Select = React__default['default'].forwardRef(function Select(_ref, ref) {
  ...
  var Textarea = React__default['default'].forwardRef(function Textarea(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "textarea",
      variant: "textarea"
  ...
  var RadioIcon = function RadioIcon(props) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(RadioChecked, _extends({}, props, {
      __css: {
        display: 'none',
        'input:checked ~ &': {
          display: 'block'
  ...
  var Radio = React__default['default'].forwardRef(function Radio(_ref, ref) {
  ...
  var CheckboxIcon = function CheckboxIcon(props) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(CheckboxChecked, _extends({}, props, {
      __css: {
        display: 'none',
        'input:checked ~ &': {
          display: 'block'
  ...
  var Checkbox = React__default['default'].forwardRef(function Checkbox(_ref, ref) {
    var className = _ref.className,
        sx = _ref.sx,
        _ref$variant = _ref.variant,
  ...
  var GUTTER = 2;
  var SIZE = 18;
  var Switch = React__default['default'].forwardRef(function Switch(_ref, ref) {
    var className = _ref.className,
        label = _ref.label,
        sx = _ref.sx,
        _ref$variant = _ref.variant,
  ...
  var Slider = React__default['default'].forwardRef(function Slider(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "input",
      type: "range",
  ...
  var Field = React__default['default'].forwardRef(function Field(_ref, ref) {
    var _ref$as = _ref.as,
  ...
  var Progress = React__default['default'].forwardRef(function Progress(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "progress",
  ...
  var Donut = React__default['default'].forwardRef(function Donut(_ref, ref) {
    var _ref$size = _ref.size,
  ...
  var Spinner = React__default['default'].forwardRef(function Spinner(_ref, ref) {
    var _ref$size = _ref.size,
  ...
  var Avatar = React__default['default'].forwardRef(function Avatar(_ref, ref) {
    var _ref$size = _ref.size,
        size = _ref$size === void 0 ? 48 : _ref$size,
        props = _objectWithoutPropertiesLoose(_ref, ["size"]);
  ...
  var Badge = React__default['default'].forwardRef(function Badge(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      variant: "primary"
    }, props, {
  ...
  var IconButton = React__default['default'].forwardRef(function IconButton(_ref, ref) {
    var _props$__css;
  ...
  var x = /*#__PURE__*/React__default['default'].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    fill: "currentcolor",
  ...
  var Close = React__default['default'].forwardRef(function Close(_ref, ref) {
    var _ref$size = _ref.size,
        size = _ref$size === void 0 ? 32 : _ref$size,
        props = _objectWithoutPropertiesLoose(_ref, ["size"]);
  ...
  var Alert = React__default['default'].forwardRef(function Alert(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      variant: "primary"
    }, props, {
  ...
  var Divider = React__default['default'].forwardRef(function Divider(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      as: "hr",
      variant: "styles.hr"
  ...
  var Embed = React__default['default'].forwardRef(function Embed(_ref, ref) {
  ...
  var AspectRatio = React__default['default'].forwardRef(function AspectRatio(_ref, ref) {
  ...
  var AspectImage = React__default['default'].forwardRef(function AspectImage(_ref, ref) {
  ...
  var Container = React__default['default'].forwardRef(function Container(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref,
      variant: "container"
    }, props, {
  ...
  var NavLink = React__default['default'].forwardRef(function NavLink(props, ref) {
  ...
  var Message = React__default['default'].forwardRef(function Message(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(Box, _extends({
      ref: ref
    }, props, {
      __themeKey: "messages",
  ...
  var MenuButton = React__default['default'].forwardRef(function MenuButton(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(IconButton, _extends({
      ref: ref,
      title: "Menu",
