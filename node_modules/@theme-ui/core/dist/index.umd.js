(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@emotion/react'), require('react'), require('deepmerge'), require('@emotion/react/package.json'), require('@theme-ui/parse-props'), require('@theme-ui/css')) :
  typeof define === 'function' && define.amd ? define(['exports', '@emotion/react', 'react', 'deepmerge', '@emotion/react/package.json', '@theme-ui/parse-props', '@theme-ui/css'], factory) :
  (global = global || self, factory(global.core = {}, global.react, global.react, global.deepmerge, global.packageInfo, global.parseProps, global.css));
}(this, (function (exports, react, React, deepmerge, packageInfo, parseProps, css) {
  ...
  var __ThemeUIContext = React.createContext({
